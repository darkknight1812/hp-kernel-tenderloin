...
cp ~/android/kernel/cm12/android_kernel_hp_tenderloin/arch/arm/boot/uImage ~/android/kernel/moboot/tools/cm12/uImage
echo "Coppied"

#Change directory to working directory
cd ~/android/kernel/moboot/tools/cm12
...
zip -f cm12_kernel_tenderloin.zip boot.img

#Create new build date
cp cm12_kernel_tenderloin.zip ~/Dropbox/cm12_kernel_tenderloin_v2_$now.zip
echo "Finished"
