...
#define L_VAL_SCPLL_CAL_MAX	0x28 /* = 1512 MHz with 27MHz source */
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
  ...
  { {1, 1},  310500,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   800000, 0x03006000},
  ...
  { {1, 1},  594000,  ACPU_SCPLL, 0, 0, 1, 0x0B, L2(4),   812500, 0x03006000},
  ...
  { {1, 1},  810000,  ACPU_SCPLL, 0, 0, 1, 0x0F, L2(8),  867500, 0x03006000},
  ...
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(14), 962500, 0x03006000},
  ...
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(20), 1150000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(20), 1175000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(21), 1200000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(21), 1225000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(21), 1237500, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(21), 1250000, 0x03006000},
  { {1, 1}, 1914000,  ACPU_SCPLL, 0, 0, 1, 0x24, L2(21), 1275000, 0x03006000},
  { {1, 1}, 2022000,  ACPU_SCPLL, 0, 0, 1, 0x26, L2(22), 1300000, 0x03006000},
  { {1, 1}, 2103000,  ACPU_SCPLL, 0, 0, 1, 0x27, L2(22), 1325000, 0x03006000},
  { {1, 1}, 2157000,  ACPU_SCPLL, 0, 0, 1, 0x28, L2(22), 1350000, 0x03006000},
  { {0, 0}, 0 },
};
