...
mkimage -A arm -O linux -T multi -a 0x40208000  -e  0x40208000 -C none -n "multi image" -d uImage:uRamdisk  uImage.CyanogenModuv.new
echo "Uimage Complete"

#Copy the uimage into boot.img
cp -f uImage.CyanogenModuv.new boot.img
