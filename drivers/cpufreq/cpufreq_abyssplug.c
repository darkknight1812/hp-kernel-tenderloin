...
/* ignore load resulted by nice processes while making scaling decisions */
#define DEFAULT_IGNORE_NICE_LOAD			(0)

/* treating io wait time as CPU busy time */
#define DEFAULT_IO_IS_BUSY				(1)

/* override default boost timeout (uSec); '0' means boost timeout is calculated */
/* when abyssplug is used for the first time; 30x DEFAULT_SAMPLING_PERIOD */
/* calculated as default */
#define DEFAULT_BOOST_TIMEOUT				(0)
...
static struct dbs_tuners {
	...
	.ignore_nice =			DEFAULT_IGNORE_NICE_LOAD,
